...
def projeto(request):
    ...
    if request.method == 'POST':
        if request.POST.get("bones"):
            ...
            g.addElo(BFS.Node("Start"), BFS.Node("A1 Pictures"))
            g.addElo(BFS.Node("Start"), BFS.Node("Artland"))
            g.addElo(BFS.Node("Start"), BFS.Node("Bones"))
            g.addElo(BFS.Node("Start"), BFS.Node("Clover Works"))
            g.addElo(BFS.Node("Start"), BFS.Node("David Production"))
            g.addElo(BFS.Node("Start"), BFS.Node("Studio Deen"))
            g.addElo(BFS.Node("Start"), BFS.Node("feel"))
            g.addElo(BFS.Node("Start"), BFS.Node("Gainax"))
            g.addElo(BFS.Node("Start"), BFS.Node("Production IG"))
            g.addElo(BFS.Node("Start"), BFS.Node("JC Staff"))
            g.addElo(BFS.Node("Start"), BFS.Node("Kinema Citrus"))
            g.addElo(BFS.Node("Start"), BFS.Node("Kyoto Animation"))
            g.addElo(BFS.Node("Start"), BFS.Node("Mad House"))
            g.addElo(BFS.Node("Start"), BFS.Node("Mappa"))
            g.addElo(BFS.Node("Start"), BFS.Node("PA Works"))
            g.addElo(BFS.Node("Start"), BFS.Node("Studio Pierrot"))
            g.addElo(BFS.Node("Start"), BFS.Node("Sunrise"))
            g.addElo(BFS.Node("Start"), BFS.Node("TMS Entertainment"))
            g.addElo(BFS.Node("Start"), BFS.Node("Toei Animation"))
            g.addElo(BFS.Node("Start"), BFS.Node("Trigger"))
            g.addElo(BFS.Node("Start"), BFS.Node("Ufotable"))
            g.addElo(BFS.Node("Start"), BFS.Node("Studio VOLN"))
            g.addElo(BFS.Node("Start"), BFS.Node("White Fox"))
            g.addElo(BFS.Node("Start"), BFS.Node("Wit Studio"))
